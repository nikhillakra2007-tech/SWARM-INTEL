...
# Swarm — canonical schema lives in database/schema/*.sql
# Alembic is kept in sync but does not autogenerate competing tables
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..'))
from app.database.base import Base  # noqa
import app.models  # noqa — ensure all models imported
